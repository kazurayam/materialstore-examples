...
[source,java]
----
include::../src/test/java/com/kazurayam/materialstore/tutorial/ch3/InspectingMultipleURLs1.java[lines=84..130]
----
...
[source,java]
----
include::../src/test/java/com/kazurayam/materialstore/tutorial/ch3/InspectingMultipleURLs2.java[lines=84..111]
----
