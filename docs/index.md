-   [materialstore tutorial](#materialstore-tutorial)
    ...
    -   [Visual Inspection --- Twins Mode](#visual-inspection-twins-mode)
    -   [Visual Inspection --- Chronos Mode](#visual-inspection-chronos-mode)
...
13. The lines in the `index` file are NOT sorted by the physical file name (`ID`).
...
This report is generated by a class [MaterialListReporter](https://github.com/kazurayam/materialstore/blob/main/src/main/java/com/kazurayam/materialstore/report/MaterialListReporterImpl.java).
...
## Visual Inspection --- Twins Mode

## Visual Inspection --- Chronos Mode
